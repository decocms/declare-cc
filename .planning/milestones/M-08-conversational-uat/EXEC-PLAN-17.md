...
<task type="auto">
  <name>Task 1: Write workflows/verify.md</name>
...
Context: This action causes M-08 ("Conversational UAT") which realizes D-03: Post-Execution Quality Loops
  ...
  <done>Write workflows/verify.md is complete and verified</done>
</task>
...
<success_criteria>
Write workflows/verify.md is complete, verified, and advances milestone M-08
</success_criteria>
