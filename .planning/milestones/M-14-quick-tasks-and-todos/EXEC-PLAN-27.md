...
<objective>
Add quick-task and todo CJS commands
...
<task type="auto">
  <name>Task 1: Add quick-task and todo CJS commands</name>
...
Context: This action causes M-14 ("Quick tasks and todos") which realizes D-05: Full Declare Namespace
  ...
  <done>Add quick-task and todo CJS commands is complete and verified</done>
</task>
...
<success_criteria>
Add quick-task and todo CJS commands is complete, verified, and advances milestone M-14
</success_criteria>
